...
c------------- En np
       ...
       W4_np = rop(np+v1) * rop(np+v4)
       rho_e_cin_np = 0.5*(W2_np**2 + W3_np**2 + W4_np**2)
...
c------------- En l
       ...
       W4_l = rop(l+v1) * rop(l+v4)
       rho_e_cin_l = 0.5*(W2_l**2 + W3_l**2 + W4_l**2)
...
c------------- En np
       ...
       dpRop4_dpW1_np = -W4_np/(W1_np**2)
       dpRop4_dpW4_np = 1./W1_np
     ...
     &                  2 * rho_e_cin_np/(W1_np**3))
       ...
       dpRop5_dpW4_np = - 1./Cvm * W4_np/(W1_np**2)
