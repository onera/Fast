...
c     $Author: IvanMary $
c*****a*****************************************************************
      subroutine conservrk3local4(param_int,param_int2,coe,coe2,
...
#include "FastS/param_solver.h"
      ...
      REAL_E constk1(taille,param_int(NEQ))
      REAL_E constk2(taille,param_int(NEQ))
...
#include "FastS/formule_param.h"                          
     ...
     &                + rop(l,4)*rop(l,4)))   
       ...
       !print*,lstkzv
      !if (j==85) then
      !   print*,rop(l,1),ro_old, constk1(lstk,1),constk2(lstkzv,1)
      !end if
