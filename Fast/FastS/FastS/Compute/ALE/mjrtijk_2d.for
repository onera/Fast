...
c     $Author: IvanMary $
c***********************************************************************
      subroutine mjrtijk_2d(ndom, ithread,
...
C Var loc
      INTEGER_E  i,j,k,lt,lt2,lt3,ltij, icorr,jcorr,v1mtr,v2mtr,v3mtr,
     & ind_loop(6)
...
#include          "FastS/Compute/ALE/tijk_2d_j.for"
            enddo

#include    "FastS/Compute/ALE/loopI_begin.for"
#include          "FastS/Compute/ALE/tijk_2d_i.for"
            enddo
