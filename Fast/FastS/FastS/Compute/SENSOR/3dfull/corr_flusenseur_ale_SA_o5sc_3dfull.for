...
c***********************************************************************
      subroutine corr_flusenseur_ale_SA_o5sc_3dfull(ndom,
...
#include "FastS/param_solver.h"
     ...
     &        tk( param_int(NDIMDX_MTR) * param_int(NEQ_K ) )
      ...
      REAL_E flux( size_flux* param_int(NEQ) )
...
C Var loc
     ...
     & sl_i,sl_j,sl_k,shift_wig, np2,nm3,c28,li,
     ...
     & c50,c51,c52,c53,c54,df,wig_cte,
...
#include "FastS/formule_vent_param.h"    
      ...
      INTEGER_E indbci
      indbci(j_1,k_1)=1+ c28*(j_1-inc_bc(2) +(k_1-inc_bc(3))*inc_bc(1) )
...
CC!DIR$ ASSUME_ALIGNED xmut: CACHELINE
      ...
      !adaptation adresse tableau flux
      c28=0
      if(bctype.eq.BCFluxOctreeF.or.bctype.eq.BCFluxOctreeC) c28=1
...
#include "FastS/Compute/pragma_align.for"
      ...
      !! raccord nearmatch zone fine: on stocke le flux
      IF(bctype.eq.BCFluxOctreeF) THEN
...
#include  "FastS/Compute/loopI_ale_begin.for"
            ...
            l0= indbci(j, k)
#include    "FastS/Compute/SENSOR/3dfull/fluFaceEuler_ale_o5sc_3dfull_i.for"
#include    "FastS/Compute/SENSOR/3dfull/fluFaceSA_ale_o5sc_3dfull_i.for"
#include    "FastS/Compute/SA/fluvisq_3dfull_i.for"          
#include    "FastS/Compute/SA/fluvisq_SA_3dfull_i.for"            
#include    "FastS/Compute/SA/stk_flux.for"
          enddo
          ENDDO
          ENDDO
...
#include  "FastS/Compute/loopI_ale_begin.for"
            ...
            i = l -lij-1 +ind_loop(1)
            l0= indbci(i,  k )
#include    "FastS/Compute/SENSOR/3dfull/fluFaceEuler_ale_o5sc_3dfull_j.for"
#include    "FastS/Compute/SENSOR/3dfull/fluFaceSA_ale_o5sc_3dfull_j.for"
...
#include  "FastS/Compute/loopI_ale_begin.for"         
            ...
            i = l -lij-1 +ind_loop(1)             
            l0= indbci(i,  j )                    
#include    "FastS/Compute/SENSOR/3dfull/fluFaceEuler_ale_o5sc_3dfull_k.for"    
#include    "FastS/Compute/SENSOR/3dfull/fluFaceSA_ale_o5sc_3dfull_k.for"     
...
#include    "FastS/Compute/SA/stk_flux.for"         
      ...
      !!on soustrait le flux du bilan drodm
      ELSE
        If(idir.le.2) Then
...
#include    "FastS/Compute/SA/fluvisq_3dfull_i.for"          
#include    "FastS/Compute/SA/fluvisq_SA_3dfull_i.for"            
#include    "FastS/Compute/SA/assemble_drodm_corrflu.for"
          enddo
          ENDDO
          ENDDO
