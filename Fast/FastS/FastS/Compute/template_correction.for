...
#include  "FastS/Compute/loopI_begin.for"         !3D only
                                                  !3D only
            i = l -lij-1 +ind_loop(1)             !3D only
            l0= indbci(i,  j )                    !3D only
...
#include    "FastS/Compute/stk_flux.for"         !3D only
          enddo                                  !3D only
          ENDDO                                  !3D only
          ENDDO                                  !3D only
        Endif !dirs
...
#include  "FastS/Compute/loopI_begin.for"         !3D only
            ...
            l0= l  - shift                        !3D only
            i = l -lij-1 +ind_loop(1)             !3D only
            li= indbci(i,  j )                    !3D only
#include    "FastS/Compute/FLUX_CONV/fluFaceEuler_k.for"    !3D only
#include    "FastS/Compute/FLUX_CONV/fluFaceRans_k.for"     !3D only
#include    "FastS/Compute/fluViscLaminar_k.for"            !3D only
#include    "FastS/Compute/fluViscRans_k.for"               !3D only
#include    "FastS/Compute/assemble_drodm_corrflu.for"      !3D only
          enddo                                  !3D only
          ENDDO                                  !3D only
          ENDDO                                  !3D only
        Endif !dirs
