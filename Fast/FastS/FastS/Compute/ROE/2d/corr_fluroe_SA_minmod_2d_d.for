...
C
C  Differentiation of corr_fluroe_sa_minmod_2d in forward (tangent) mode:
...
C     $Author: IvanMary $
C***********************************************************************
      SUBROUTINE CORR_FLUROE_SA_MINMOD_2D_D(ndom, ithread, idir, 
...
C
     ...
     +       , tdud, p1p2d, cd, qm1d, qm2d, qm3d, qm5d, qm6d, qp1d, qp2d
     +       , qp3d, qp5d, qp6d, flu1d, flu2d, flu3d, flu5d, flu6d, p1d
     +       , p2d, f1d, f3d, f4d, delpd, delmd, delqd, slqd, slpd, 
...
Ci   - i-1
                ...
                ELSE
                  ...
                  x1 = -delm
                END IF
                y27d = SIGN(1., delm)*delpd
                y27 = SIGN(1., delm)*delp
                IF (x1 .GT. y27) THEN
                  y2d = y27d
                  y2 = y27
                ELSE
...
C
                ...
                ELSE
                  ...
                  x2 = -delq
                END IF
                y28d = SIGN(1., delq)*delmd
                y28 = SIGN(1., delq)*delm
                IF (x2 .GT. y28) THEN
                  y3d = y28d
                  y3 = y28
                ELSE
...
Ci   - i-1
                ...
                ELSE
                  ...
                  x3 = -delm
                END IF
                y29d = SIGN(1., delm)*delpd
                y29 = SIGN(1., delm)*delp
                IF (x3 .GT. y29) THEN
                  y5d = y29d
                  y5 = y29
                ELSE
...
C
                ...
                ELSE
                  ...
                  x4 = -delq
                END IF
                y30d = SIGN(1., delq)*delmd
                y30 = SIGN(1., delq)*delm
                IF (x4 .GT. y30) THEN
                  y6d = y30d
                  y6 = y30
                ELSE
...
Ci   - i-1
                ...
                ELSE
                  ...
                  x5 = -delm
                END IF
                y31d = SIGN(1., delm)*delpd
                y31 = SIGN(1., delm)*delp
                IF (x5 .GT. y31) THEN
                  y8d = y31d
                  y8 = y31
                ELSE
...
C
                ...
                ELSE
                  ...
                  x6 = -delq
                END IF
                y32d = SIGN(1., delq)*delmd
                y32 = SIGN(1., delq)*delm
                IF (x6 .GT. y32) THEN
                  y9d = y32d
                  y9 = y32
                ELSE
...
Ci   - i-1
                ...
                ELSE
                  ...
                  x7 = -delm
                END IF
                y33d = SIGN(1., delm)*delpd
                y33 = SIGN(1., delm)*delp
                IF (x7 .GT. y33) THEN
                  y11d = y33d
                  y11 = y33
                ELSE
...
C
                ...
                ELSE
                  ...
                  x8 = -delq
                END IF
                y34d = SIGN(1., delq)*delmd
                y34 = SIGN(1., delq)*delm
                IF (x8 .GT. y34) THEN
                  y12d = y34d
                  y12 = y34
                ELSE
...
Cvitesse interface moyenne Roe depuis etat G et D ordre1
                qp6d = ropd(nm+v6)*qp1*qn1 + rop(nm+v6)*(qp1d*qn1+qp1*
     +            qn1d)
...
COut: qn1, qn2 (vitesse interface depuis etat G et D
                ...
                END IF
C
                flu6d = 0.5*(qm6d+qp6d-tdud*(rop(l+v6)*rop(l+v1)-rop(nm+
     +            v6)*rop(nm+v1))-tdu*(ropd(l+v6)*rop(l+v1)+rop(l+v6)*
     +            ropd(l+v1)-ropd(nm+v6)*rop(nm+v1)-rop(nm+v6)*ropd(nm+
     +            v1)))
...
C      flu6 = 0.5*(qm6 + qp6 +sign(1.,flu1)*(qp6-qm6))
                ...
                drodmd(l0+v6) = drodmd(l0+v6) + sens*flu6d
              ENDDO
            ENDDO
          ENDDO
...
Ci   - i-1
                ...
                ELSE
                  ...
                  x9 = -delm
                END IF
                y35d = SIGN(1., delm)*delpd
                y35 = SIGN(1., delm)*delp
                IF (x9 .GT. y35) THEN
                  y15d = y35d
                  y15 = y35
                ELSE
...
C
                ...
                ELSE
                  ...
                  x10 = -delq
                END IF
                y36d = SIGN(1., delq)*delmd
                y36 = SIGN(1., delq)*delm
                IF (x10 .GT. y36) THEN
                  y16d = y36d
                  y16 = y36
                ELSE
...
Ci   - i-1
                ...
                ELSE
                  ...
                  x11 = -delm
                END IF
                y37d = SIGN(1., delm)*delpd
                y37 = SIGN(1., delm)*delp
                IF (x11 .GT. y37) THEN
                  y18d = y37d
                  y18 = y37
                ELSE
...
C
                ...
                ELSE
                  ...
                  x12 = -delq
                END IF
                y38d = SIGN(1., delq)*delmd
                y38 = SIGN(1., delq)*delm
                IF (x12 .GT. y38) THEN
                  y19d = y38d
                  y19 = y38
                ELSE
...
Ci   - i-1
                ...
                ELSE
                  ...
                  x13 = -delm
                END IF
                y39d = SIGN(1., delm)*delpd
                y39 = SIGN(1., delm)*delp
                IF (x13 .GT. y39) THEN
                  y21d = y39d
                  y21 = y39
                ELSE
...
C
                ...
                ELSE
                  ...
                  x14 = -delq
                END IF
                y40d = SIGN(1., delq)*delmd
                y40 = SIGN(1., delq)*delm
                IF (x14 .GT. y40) THEN
                  y22d = y40d
                  y22 = y40
                ELSE
...
Ci   - i-1
                ...
                ELSE
                  ...
                  x15 = -delm
                END IF
                y41d = SIGN(1., delm)*delpd
                y41 = SIGN(1., delm)*delp
                IF (x15 .GT. y41) THEN
                  y24d = y41d
                  y24 = y41
                ELSE
...
C
                ...
                ELSE
                  ...
                  x16 = -delq
                END IF
                y42d = SIGN(1., delq)*delmd
                y42 = SIGN(1., delq)*delm
                IF (x16 .GT. y42) THEN
                  y25d = y42d
                  y25 = y42
                ELSE
