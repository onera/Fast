...
C
C  Differentiation of fluroe_sa_o3_3dfull in forward (tangent) mode:
...
C     $Author: IvanMary $
C***********************************************************************
      SUBROUTINE FLUROE_SA_O3_3DFULL_D(ndom, ithread, param_int, 
...
C
     ...
     +       gradw_nzd, gradt_nxd, gradt_nyd, gradt_nzd, dud, dvd, dwd, 
     +       dpd, dqnd, qnd, rd, vd, wd, hd, qd, r_1d, xktvold, xmulamd
     +       , xmuturd, xmutotd
C
