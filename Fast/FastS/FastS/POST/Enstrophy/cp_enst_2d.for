...
c     $Author: IvanMary $
c***********************************************************************
      subroutine cp_enst_2d(ndom, ithread, dim_grad,
     &                         param_int, c1,c2,
     &                         ind_loop,
...
C Var loc
      INTEGER_E inc,incmax,l,lt,i,j,k,incmax2,l5,l6,l3,l4,
     & l0,lt0,inci,incj,inck,ci,cj,lij,ltij,inci_mtr, incj_mtr,
     & inck_mtr,icorr,jcorr,ls,v1,v2,v3,v4,v5,lvo,
     & inc2i,inc2j,inc2k,incdir,v1mtr,v2mtr,v3mtr,
     & Vdudx,Vdvdx,Vdwdx, Vvar, Vgrad, lg
...
#include   "FastS/POST/Enstrophy/enstrophy_2d.for"
      ENDDO
      ENDDO !do j
