...
c     $Author: IvanMary $
c***********************************************************************
      subroutine cp_q_enst_3dfull(ndom, ithread, dim_grad,
     &                         param_int, c1,c2,
     &                         ind_loop,
     &                         ind_dm, ijkv_cache,
...
#include "FastS/param_solver.h"
     ...
     & synchro_send_th(3), synchro_receive_th(3), param_int(0:*)
      ...
      REAL_E      Q( param_int(NDIMDX) ),enst( param_int(NDIMDX) )
...
#include "FastS/POST/loopI_begin.for"
           ...
           !
           !pour gradU
#include   "FastS/POST/GradU/normale_3dfull_k.for"
           Vgrad = Vdudx
           Vvar  = v2
#include   "FastS/POST/GradU/gradvar_3dfull_init.for"
           !pour gradV
           Vgrad = Vdvdx
           Vvar  = v3
#include   "FastS/POST/GradU/gradvar_3dfull_init.for"
...
#include "FastS/POST/loopI_begin.for"
           ...
           !
           !pour gradU
#include   "FastS/POST/GradU/normale_3dfull_j.for"
           Vgrad = Vdudx
           Vvar  = v2
#include   "FastS/POST/GradU/gradvar_3dfull.for"
           !pour gradV
           Vgrad = Vdvdx
           Vvar  = v3
#include   "FastS/POST/GradU/gradvar_3dfull.for"
...
#include"FastS/POST/loopI_begin.for"
           ...
           !
           !pour gradU
#include   "FastS/POST/GradU/normale_3dfull_i.for"
           Vgrad = Vdudx
           Vvar  = v2
#include   "FastS/POST/GradU/gradvar_3dfull.for"
           !pour gradV
