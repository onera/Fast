...
c     $Author: IvanMary $
c***********************************************************************
      subroutine cp_gradu_3dcart(ndom, ithread, neq_grad,
     &                         param_int, c1,c2,
     &                         ind_loop,
...
#include        "FastS/POST/loopI_begin.for"
                  ...
                  l0= l  - inck                    
#include          "FastS/POST/grad_k_3dcart.for"
                enddo

#include        "FastS/POST/loopI_begin.for"
                
                  l0= l  - incj  !on modifie rhs(j et j-1)
#include          "FastS/POST/grad_j_3dcart.for"
                enddo

#include       "FastS/POST/loopI_begin.for"
                
                  l0= l  - inci
#include          "FastS/POST/grad_i_3dcart.for"
                enddo
...
#include          "FastS/POST/grad_i_3dcart_send.for"
                endif ! 
       ENDDO !do j
...
#include       "FastS/POST/loopI_begin.for"
                  ...
                  ls = l -incj
#include          "FastS/POST/grad_j_3dcart_send.for"
               enddo
        Endif
...
#include    "FastS/POST/loopI_begin.for"
                 ...
                 ls = l -inck
#include        "FastS/POST/grad_k_3dcart_send.for"
            enddo
          enddo
      Endif
      end
