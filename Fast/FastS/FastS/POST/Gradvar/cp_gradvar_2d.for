...
c     $Author: IvanMary $
c***********************************************************************
      subroutine cp_gradvar_2d(ndom, ithread, neq_grad,
     &                       param_int, c1,c2,
     &                       ind_loop,
...
#include          "FastS/POST/Gradvar/grad_j_2d.for"
                enddo

#include       "FastS/POST/loopI_begin.for"
                
                  l0= l  - inci
#include          "FastS/POST/Gradvar/grad_i_2d.for"
                enddo
...
#include          "FastS/POST/Gradvar/grad_i_2d_send.for"
                endif ! 
       ENDDO !do j
...
#include       "FastS/POST/loopI_begin.for"
                  ...
                  ls = l -incj
#include          "FastS/POST/Gradvar/grad_j_2d_send.for"
               enddo
        Endif
