...
c     $Author: IvanMary $
c***********************************************************************
      subroutine cp_gradvar_3dfull(ndom, ithread, neq_grad,
     &                         param_int, c1,c2,
     &                         ind_loop,
...
#include "FastS/param_solver.h"
     ...
     & synchro_receive_sock(3), synchro_receive_th(3), param_int(0:*)
      ...
      REAL_E    rop( param_int(NDIMDX) )
      REAL_E dvardc( param_int(NDIMDX) * neq_grad )
...
C Var loc
     ...
     & inck_mtr,icorr,jcorr,ls,v1,v2,v3,
...
#include        "FastS/POST/loopI_begin.for"
                  ...
                  l0= l  - inck                    
#include          "FastS/POST/Gradvar/grad_k_3dfull.for"
                enddo

#include        "FastS/POST/loopI_begin.for"
                
                  l0= l  - incj  !on modifie rhs(j et j-1)
#include          "FastS/POST/Gradvar/grad_j_3dfull.for"
                enddo

#include       "FastS/POST/loopI_begin.for"
                
                  l0= l  - inci
#include          "FastS/POST/Gradvar/grad_i_3dfull.for"
                enddo
...
#include          "FastS/POST/Gradvar/grad_i_3dfull_send.for"
                endif ! 
       ENDDO !do j
...
#include       "FastS/POST/loopI_begin.for"
                  ...
                  ls = l -incj
#include          "FastS/POST/Gradvar/grad_j_3dfull_send.for"
               enddo
        Endif
...
#include    "FastS/POST/loopI_begin.for"
                 ...
                 ls = l -inck
#include        "FastS/POST/Gradvar/grad_k_3dfull_send.for"
            enddo
          enddo
      Endif
      end
