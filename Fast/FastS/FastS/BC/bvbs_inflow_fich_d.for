...
C
C  Differentiation of bvbs_inflow_fich in forward (tangent) mode:
...
C     $Author: IvanMary $
C***********************************************************************
      SUBROUTINE BVBS_INFLOW_FICH_D(idir, lrhs, neq_mtr, param_int, 
     +                              ind_loop, param_real, c4, c5, c6, 
     +                              ventijk, tijk, rop, ropd, d0x, d0y, 
     +                              d0z, pa, ha, nue, size_data, inc_bc
     +                              , size_work)
      IMPLICIT NONE
C
...
C Var local
     ...
     +          ldp, lmtr, l0, incj, inck, indbci, li
     ...
     +       snorm, gamm1, gamm1_1, cvinv, sni, tn, qn, qen, eigv1, 
     ...
     +       , eti, tnx
      REAL*8 tny, ri, roinv, sn, roe_inv, mach, pref, roi0, ru
      REAL*8 ud, vd, wd, eted, qref1d, qref2d, qref3d, qref4d, qref5d, 
     +       rd, pd, cd, cid, qvar1d, qvar2d, qvar3d, qvar4d, qvar5d, 
     +       svar1d, svar2d, svar3d, svar4d, svar5d, rvar1d, rvar2d, 
     +       rvar3d, rvar4d, rvar5d, roextd, ruextd, rvextd, rwextd, 
     +       etextd, rointd, ruintd, rvintd, rwintd, etintd, roid, ruid
...
Cif(param_int(36).eq.6) nue = state(6)/roe
Cwrite(*,*)'state', roe,rue,rve,ete
...
C
              ...
              rwe = ru*d0z(li)
C
              eted = param_real(2)*(ropd(l1, 5)*rop(l1, 1)+rop(l1, 5)*
     +          ropd(l1, 1))
              ete = rop(l1, 5)*rop(l1, 1)*param_real(2) + 0.5*(rue*rue+
     +          rve*rve+rwe*rwe)*roe_inv
C
...
C
     ...
     +          qvar2*ud-qvar3*vd-qvar4*wd+qvar5d)
...
C
              ...
              ropd(l, 3) = vd
              ropd(l, 4) = wd
              ropd(l, 5) = roe_inv*(ropd(l1, 5)*rop(l1, 1)+rop(l1, 5)*
     +          ropd(l1, 1))
C
              l0 = l
              l2 = l + 2
