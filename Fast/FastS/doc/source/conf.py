# -*- coding: utf-8 -*-
#
# FastS documentation build configuration file
...
latex_documents = [
  ('FastS', 'FastS.tex', u'FastS Documentation',
   u'/FAST/MU-02/V'+__version__, 'manual'),
]
...
texinfo_documents = [
  ('index', 'FastS', u'FastS Documentation',
   u'ONERA', 'FastS', 'One line description of project.',
   'Miscellaneous'),
]
