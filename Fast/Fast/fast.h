...
{ 
  ...
  E_Int gsdr3( 
	      ...
	      E_Float* ipt_VectY         , E_Float** ipt_ssor          ,
	      E_Float** ipt_ssortmp      , E_Int* ipt_ssor_size        ,
	      ...
	      E_Float**  iptCellN_IBC    , E_Int**  iptdegen           ,
	      E_Float**& iptro           , E_Float**& iptro_m1         ,
	      E_Float**&  iptrotmp       , E_Float**& iptro_sfd        ,
	      ...
	      E_Float*  iptcoe           , E_Float* iptmules           ,
	      E_Float**& iptdelta        , E_Float**& iptro_res        ,
	      E_Float**& iptdrodm_trans  , E_Int*&  ipt_param_int_tc   ,
	      E_Float*& ipt_param_real_tc, E_Int*& ipt_linelets_int    ,
	      E_Float*& ipt_linelets_real, E_Int& taille_tabs          ,
