...
c     $Author: IvanMary $
c***********************************************************************
      subroutine core3as2_chim(ndom,nitcfg, first_it,
...
#include  "loop_core_begin.for"
     ...
     &                 +( c4*rop   (l,2)*rop   (l,1)
     &                   +c3*rop_n1(l,2)*rop_n1(l,1) )*amor

            drodm(l,3)= coe(l,1)*drodm(l,3) 
     &                 +( c4*rop   (l,3)*rop   (l,1)
     &                   +c3*rop_n1(l,3)*rop_n1(l,1) )*amor

            drodm(l,4)= coe(l,1)*drodm(l,4) 
     &                 +( c4*rop   (l,4)*rop   (l,1)
     &                   +c3*rop_n1(l,4)*rop_n1(l,1) )*amor
