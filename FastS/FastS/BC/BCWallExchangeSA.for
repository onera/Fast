#include  "FastS/BC/BCWallExchange.for"
      ...
      nutcible = abs( kappa*rop(l,1)*xmut(l,2)*utau*expy**2)!negatif si pt ibc interieur aux corps
      !equation 4eme degre
      nu = (coesut * sqrt(rop(l,5))*rop(l,5)/(rop(l,5)+cmus1))/rop(l,1)
      a = nutcible/nu
      b = a*cv1*cv1*cv1
