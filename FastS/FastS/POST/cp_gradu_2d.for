...
c     $Author: IvanMary $
c***********************************************************************
      subroutine cp_gradu_2d(ndom, ithread, neq_grad,
     &                       param_int, c1,c2,
     &                       ind_loop,
...
#include          "FastS/POST/grad_j_2d.for"
                enddo

#include       "FastS/POST/loopI_begin.for"
                
                  l0= l  - inci
#include          "FastS/POST/grad_i_2d.for"
                enddo
...
#include          "FastS/POST/grad_i_2d_send.for"
                endif ! 
       ENDDO !do j
...
#include       "FastS/POST/loopI_begin.for"
                  ...
                  ls = l -incj
#include          "FastS/POST/grad_j_2d_send.for"
               enddo
        Endif
