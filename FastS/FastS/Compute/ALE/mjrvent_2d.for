...
c     $Author: IvanMary $
c***********************************************************************
      subroutine mjrvent_2d(ndom, ithread,
...
C Var loc
      INTEGER_E i,j,k,l,l1,l2,l3,lij,lxij,inci,incj,inck,
     & icorr,jcorr,v1ven,v2ven,v3ven,lx1,lx2,lx3,lx4,l111,
     & ind_loop(6)
...
#include          "FastS/Compute/ALE/ventijk_2d_j.for"
            enddo

#include    "FastS/Compute/ALE/loopIvent_begin.for"
#include          "FastS/Compute/ALE/ventijk_2d_i.for"
            enddo
