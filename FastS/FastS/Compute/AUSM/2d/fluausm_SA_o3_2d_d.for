...
C
C  Differentiation of fluausm_sa_o3_2d in forward (tangent) mode:
...
C     $Author: IvanMary $
C***********************************************************************
      SUBROUTINE FLUAUSM_SA_O3_2D_D(ndom, ithread, param_int, param_real
...
C
     ...
     +       , qm5d, qm6d, qp1d, qp2d, qp3d, qp5d, qp6d, flu1d, flu2d, 
     +       flu3d, flu5d, flu6d, p1d, p2d, divd, f1d, f2d, f3d, f4d, 
     +       f5d, f6d, fvd, fv5d, xmutvold, sond, cd, gradu_nxd, 
     +       gradu_nyd, gradv_nxd, gradv_nyd, gradt_nxd, gradt_nyd, 
...
C qm: right state,  qp: left state
     ...
     +          vslp)
              qp = c4*rop(nm+vslp) + c6*rop(nm2+vslp) + c5*rop(l+vslp)
              qm6d = qmd*qm1 + qm*qm1d
              qm6 = qm*qm1
              qp6d = qpd*qp1 + qp*qp1d
              qp6 = qp*qp1
C
C1=?+1; 
C3=?+2 
...
C4=?-2
Cl341  = (i+2,j-2,k+1)
              flu6d = ud*(qm6+qp6) + u*(qm6d+qp6d) - tdud*(qm6-qp6) - 
     +          tdu*(qm6d-qp6d)
