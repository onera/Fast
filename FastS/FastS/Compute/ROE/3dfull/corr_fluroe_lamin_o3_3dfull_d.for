...
C
C  Differentiation of corr_fluroe_lamin_o3_3dfull in forward (tangent) mode:
...
C     $Author: IvanMary $
C***********************************************************************
      SUBROUTINE CORR_FLUROE_LAMIN_O3_3DFULL_D(ndom, ithread, idir, 
...
C
     ...
     +       f1d, f3d, f4d, dud, dvd, dwd, dpd, dqnd, qnd, rd, vd, wd, 
     +       hd, qd, r_1d
C
