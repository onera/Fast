...
C
C  Differentiation of fluroe_euler_o3_3dfull in forward (tangent) mode:
...
C     $Author: IvanMary $
C***********************************************************************
      SUBROUTINE FLUROE_EULER_O3_3DFULL_D(ndom, ithread, param_int, 
...
C
     ...
     +       f1d, f3d, f4d, cd, dud, dvd, dwd, dpd, dqnd, qnd, rd, vd, 
     +       wd, hd, qd, r_1d
C
