...
C
C  Differentiation of fluroe_sa_minmod_3dfull in forward (tangent) mode:
...
C     $Author: IvanMary $
C***********************************************************************
      SUBROUTINE FLUROE_SA_MINMOD_3DFULL_D(ndom, ithread, param_int, 
...
C
     ...
     +       , tdud, p1p2d, qm1d, qm2d, qm3d, qm4d, qm5d, qm6d, qp1d, 
     +       qp2d, qp3d, qp4d, qp5d, qp6d, flu1d, flu2d, flu3d, flu4d, 
     +       flu5d, flu6d, p1d, p2d, divd, f1d, f2d, f3d, f4d, f5d, f6d
     +       , fvd, fv5d, xmutvold, cd, gradu_nxd, gradu_nyd, gradu_nzd
     +       , gradv_nxd, gradv_nyd, gradv_nzd, gradw_nxd, gradw_nyd, 
     +       gradw_nzd, gradt_nxd, gradt_nyd, gradt_nzd, delpd, delmd, 
     +       delqd, slqd, slpd, roffd, dud, dvd, dwd, dpd, dqnd, qnd, rd
...
C
     ...
     +          qm1d*qm3+qm1*qm3d)
              ...
              qp4d = r_1d*(qp1*qp4+qm1*qm4) + r_1*(qp1d*qp4+qp1*qp4d+
     +          qm1d*qm4+qm1*qm4d)
...
C
              fvd = -((2.*tcx*f1d+tcy*f2d+tcz*f3d)*xmutvol+(2.*f1*tcx+f2
     +          *tcy+f3*tcz)*xmutvold)
     ...
     +          il+v2))
              ...
              flu2 = flu2 + fv
C
              fvd = -((tcx*f2d+2.*tcy*f4d+tcz*f5d)*xmutvol+(f2*tcx+2.*f4
     +          *tcy+f5*tcz)*xmutvold)
     ...
     +          )+ropd(il+v3))
              ...
              flu3 = flu3 + fv
C
              fvd = -((tcx*f3d+tcy*f5d+2.*tcz*f6d)*xmutvol+(f3*tcx+f5*
     +          tcy+2.*f6*tcz)*xmutvold)
     ...
     +          )+ropd(il+v4))
              ...
              flu4 = flu4 + fv
C
              fvd = 0.5*fv5d - (tcx*gradt_nxd+tcy*gradt_nyd+tcz*
     +          gradt_nzd)*xktvol - (gradt_nx*tcx+gradt_ny*tcy+gradt_nz*
     +          tcz)*xktvold
...
C--- Gradients  nutilde
              ...
              f2d = ropd(ir+v6)
              f2 = rop(ir+v6)
              f3d = ropd(ir+v6) + ropd(il+v6) + ropd(l202+v6) + ropd(
     +          l200+v6)
              f3 = rop(ir+v6) + rop(il+v6) + rop(l202+v6) + rop(l200+v6)
              f4d = ropd(ir+v6) + ropd(il+v6) + ropd(l102+v6) + ropd(
     +          l100+v6)
              f4 = rop(ir+v6) + rop(il+v6) + rop(l102+v6) + rop(l100+v6)
              f5d = ropd(ir+v6) + ropd(il+v6) + ropd(l022+v6) + ropd(
     +          l020+v6)
              f5 = rop(ir+v6) + rop(il+v6) + rop(l022+v6) + rop(l020+v6)
              f6d = ropd(ir+v6) + ropd(il+v6) + ropd(l012+v6) + ropd(
     +          l010+v6)
...
C
     ...
     +          gradt_nz*tcz) - xmutvol*(tcx*gradt_nxd+tcy*gradt_nyd+tcz
     +          *gradt_nzd)
              flu6 = flu6 - xmutvol*(gradt_nx*tcx+gradt_ny*tcy+gradt_nz*
     +          tcz)
...
CPentes annulees pour toute temperature inferieure a la temperature Tmin
              ...
              IF (rop(l+v5)*tmin_1 - .5 .GT. 1.) THEN
                ...
                y26d = 0.0
              ELSE
                y26d = tmin_1*ropd(l+v5)
                y26 = rop(l+v5)*tmin_1 - .5
              END IF
              IF (0. .LT. y26) THEN
                max26d = y26d
                max26 = y26
...
CPentes annulees pour toute temperature inferieure a la temperature Tmin
              ...
              IF (rop(l+v5)*tmin_1 - .5 .GT. 1.) THEN
                ...
                y29d = 0.0
              ELSE
                y29d = tmin_1*ropd(l+v5)
                y29 = rop(l+v5)*tmin_1 - .5
              END IF
              IF (0. .LT. y29) THEN
                max29d = y29d
                max29 = y29
...
C--- Gradients  nutilde
              ...
              f2d = ropd(ir+v6)
              f2 = rop(ir+v6)
              f3d = ropd(ir+v6) + ropd(il+v6) + ropd(l022+v6) + ropd(
     +          l002+v6)
              f3 = rop(ir+v6) + rop(il+v6) + rop(l022+v6) + rop(l002+v6)
              f4d = ropd(ir+v6) + ropd(il+v6) + ropd(l021+v6) + ropd(
     +          l001+v6)
...
CPentes annulees pour toute temperature inferieure a la temperature Tmin
              ...
              IF (rop(l+v5)*tmin_1 - .5 .GT. 1.) THEN
                ...
                y39d = 0.0
              ELSE
                y39d = tmin_1*ropd(l+v5)
                y39 = rop(l+v5)*tmin_1 - .5
              END IF
              IF (0. .LT. y39) THEN
                max39d = y39d
                max39 = y39
...
CPentes annulees pour toute temperature inferieure a la temperature Tmin
              ...
              IF (rop(l+v5)*tmin_1 - .5 .GT. 1.) THEN
                ...
                y42d = 0.0
              ELSE
                y42d = tmin_1*ropd(l+v5)
                y42 = rop(l+v5)*tmin_1 - .5
              END IF
              IF (0. .LT. y42) THEN
                max42d = y42d
                max42 = y42
...
CPentes annulees pour toute temperature inferieure a la temperature Tmin
              ...
              IF (rop(l+v5)*tmin_1 - .5 .GT. 1.) THEN
                ...
                y45d = 0.0
              ELSE
                y45d = tmin_1*ropd(l+v5)
                y45 = rop(l+v5)*tmin_1 - .5
              END IF
              IF (0. .LT. y45) THEN
                max45d = y45d
                max45 = y45
...
C
     ...
     +          l010+v6)
              ...
              f5d = ropd(ir+v6) + ropd(il+v6) + ropd(l202+v6) + ropd(
     +          l002+v6)
              f5 = rop(ir+v6) + rop(il+v6) + rop(l202+v6) + rop(l002+v6)
              f6d = ropd(ir+v6) + ropd(il+v6) + ropd(l201+v6) + ropd(
     +          l001+v6)
...
CPentes annulees pour toute temperature inferieure a la temperature Tmin
              ...
              IF (rop(l+v5)*tmin_1 - .5 .GT. 1.) THEN
                ...
                y65d = 0.0
              ELSE
                y65d = tmin_1*ropd(l+v5)
                y65 = rop(l+v5)*tmin_1 - .5
              END IF
              IF (0. .LT. y65) THEN
                max65d = y65d
                max65 = y65
...
CPentes annulees pour toute temperature inferieure a la temperature Tmin
              ...
              IF (rop(l+v5)*tmin_1 - .5 .GT. 1.) THEN
                ...
                y68d = 0.0
              ELSE
                y68d = tmin_1*ropd(l+v5)
                y68 = rop(l+v5)*tmin_1 - .5
              END IF
              IF (0. .LT. y68) THEN
                max68d = y68d
                max68 = y68
...
CPentes annulees pour toute temperature inferieure a la temperature Tmin
              ...
              IF (rop(l+v5)*tmin_1 - .5 .GT. 1.) THEN
                ...
                y71d = 0.0
              ELSE
                y71d = tmin_1*ropd(l+v5)
                y71 = rop(l+v5)*tmin_1 - .5
              END IF
              IF (0. .LT. y71) THEN
                max71d = y71d
                max71 = y71
...
CPentes annulees pour toute temperature inferieure a la temperature Tmin
              ...
              IF (rop(l+v5)*tmin_1 - .5 .GT. 1.) THEN
                ...
                y74d = 0.0
              ELSE
                y74d = tmin_1*ropd(l+v5)
                y74 = rop(l+v5)*tmin_1 - .5
              END IF
              IF (0. .LT. y74) THEN
                max74d = y74d
                max74 = y74
...
CPentes annulees pour toute temperature inferieure a la temperature Tmin
              ...
              IF (rop(l+v5)*tmin_1 - .5 .GT. 1.) THEN
                ...
                y77d = 0.0
              ELSE
                y77d = tmin_1*ropd(l+v5)
                y77 = rop(l+v5)*tmin_1 - .5
              END IF
              IF (0. .LT. y77) THEN
                max77d = y77d
                max77 = y77
...
CPentes annulees pour toute temperature inferieure a la temperature Tmin
              ...
              IF (rop(l+v5)*tmin_1 - .5 .GT. 1.) THEN
                ...
                y81d = 0.0
              ELSE
                y81d = tmin_1*ropd(l+v5)
                y81 = rop(l+v5)*tmin_1 - .5
              END IF
              IF (0. .LT. y81) THEN
                max81d = y81d
                max81 = y81
...
CPentes annulees pour toute temperature inferieure a la temperature Tmin
              ...
              IF (rop(l+v5)*tmin_1 - .5 .GT. 1.) THEN
                ...
                y84d = 0.0
              ELSE
                y84d = tmin_1*ropd(l+v5)
                y84 = rop(l+v5)*tmin_1 - .5
              END IF
              IF (0. .LT. y84) THEN
                max84d = y84d
                max84 = y84
...
CPentes annulees pour toute temperature inferieure a la temperature Tmin
              ...
              IF (rop(l+v5)*tmin_1 - .5 .GT. 1.) THEN
                ...
                y87d = 0.0
              ELSE
                y87d = tmin_1*ropd(l+v5)
                y87 = rop(l+v5)*tmin_1 - .5
              END IF
              IF (0. .LT. y87) THEN
                max87d = y87d
                max87 = y87
...
Ci   - i-1
              ...
              ELSE
                ...
                x55 = -delm
              END IF
              y151d = SIGN(1., delm)*delpd
              y151 = SIGN(1., delm)*delp
              IF (x55 .GT. y151) THEN
                y88d = y151d
                y88 = y151
              ELSE
...
C
              ...
              ELSE
                ...
                x56 = -delq
              END IF
              y152d = SIGN(1., delq)*delmd
              y152 = SIGN(1., delq)*delm
              IF (x56 .GT. y152) THEN
                y89d = y152d
                y89 = y152
              ELSE
...
CPentes annulees pour toute temperature inferieure a la temperature Tmin
              ...
              IF (rop(l+v5)*tmin_1 - .5 .GT. 1.) THEN
                ...
                y90d = 0.0
              ELSE
                y90d = tmin_1*ropd(l+v5)
                y90 = rop(l+v5)*tmin_1 - .5
              END IF
              IF (0. .LT. y90) THEN
                max90d = y90d
                max90 = y90
...
Ci   - i-1
              ...
              ELSE
                ...
                x57 = -delm
              END IF
              y153d = SIGN(1., delm)*delpd
              y153 = SIGN(1., delm)*delp
              IF (x57 .GT. y153) THEN
                y91d = y153d
                y91 = y153
              ELSE
...
C
              ...
              ELSE
                ...
                x58 = -delq
              END IF
              y154d = SIGN(1., delq)*delmd
              y154 = SIGN(1., delq)*delm
              IF (x58 .GT. y154) THEN
                y92d = y154d
                y92 = y154
              ELSE
...
CPentes annulees pour toute temperature inferieure a la temperature Tmin
              ...
              IF (rop(l+v5)*tmin_1 - .5 .GT. 1.) THEN
                ...
                y93d = 0.0
              ELSE
                y93d = tmin_1*ropd(l+v5)
                y93 = rop(l+v5)*tmin_1 - .5
              END IF
              IF (0. .LT. y93) THEN
                max93d = y93d
                max93 = y93
...
Ci   - i-1
              ...
              ELSE
                ...
                x59 = -delm
              END IF
              y155d = SIGN(1., delm)*delpd
              y155 = SIGN(1., delm)*delp
              IF (x59 .GT. y155) THEN
                y94d = y155d
                y94 = y155
              ELSE
...
C
              ...
              ELSE
                ...
                x60 = -delq
              END IF
              y156d = SIGN(1., delq)*delmd
              y156 = SIGN(1., delq)*delm
              IF (x60 .GT. y156) THEN
                y95d = y156d
                y95 = y156
              ELSE
