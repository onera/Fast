...
C
C  Differentiation of fluroe_euler_minmod_3dfull in forward (tangent) mode:
...
C     $Author: IvanMary $
C***********************************************************************
      SUBROUTINE FLUROE_EULER_MINMOD_3DFULL_D(ndom, ithread, param_int, 
     +                                        param_real, ind_dm, 
     +                                        ind_loop, ijkv_bloc, 
     +                                        ijkv_cache, 
     +                                        synchro_send_sock, 
...
C
     ...
     +       f1d, f3d, f4d, cd, delpd, delmd, delqd, slqd, slpd, roffd, 
