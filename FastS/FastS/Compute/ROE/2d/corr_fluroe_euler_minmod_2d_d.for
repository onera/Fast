...
C
C  Differentiation of corr_fluroe_euler_minmod_2d in forward (tangent) mode:
...
C     $Author: IvanMary $
C***********************************************************************
      SUBROUTINE CORR_FLUROE_EULER_MINMOD_2D_D(ndom, ithread, idir, 
...
C
     ...
     +       , flu1d, flu2d, flu3d, flu5d, p1d, p2d, f1d, f3d, f4d, 
     +       delpd, delmd, delqd, slqd, slpd, roffd, dud, dvd, dpd, dqnd
...
Ci   - i-1
                ...
                ELSE
                  ...
                  x1 = -delm
                END IF
                y25d = SIGN(1., delm)*delpd
                y25 = SIGN(1., delm)*delp
                IF (x1 .GT. y25) THEN
                  y2d = y25d
                  y2 = y25
                ELSE
...
C
                ...
                ELSE
                  ...
                  x2 = -delq
                END IF
                y26d = SIGN(1., delq)*delmd
                y26 = SIGN(1., delq)*delm
                IF (x2 .GT. y26) THEN
                  y3d = y26d
                  y3 = y26
                ELSE
