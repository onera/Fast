...
C
C  Differentiation of fluroe_sa_o3_2d in forward (tangent) mode:
...
C     $Author: IvanMary $
C***********************************************************************
      SUBROUTINE FLUROE_SA_O3_2D_D(ndom, ithread, param_int, param_real
     +                             , ind_dm, ind_loop, ijkv_bloc, 
     +                             ijkv_cache, synchro_send_sock, 
     +                             synchro_send_th, synchro_receive_sock
...
C
     ...
     +       gradt_nxd, gradt_nyd, dud, dvd, dpd, dqnd, qnd, rd, vd, hd
