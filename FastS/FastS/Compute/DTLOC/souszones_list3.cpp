...
//=============================================================================
PyObject* K_FASTS::souszones_list3(PyObject* self, PyObject* args)
{
  PyObject* zones; PyObject* metrics; PyObject* work;PyObject* zonesD;
  PyObject *pyParam_int;
  E_Int nitrun; E_Int nstep;
#if defined E_DOUBLEINT
  if (!PyArg_ParseTuple(args, "OOOOll", &zones , &zonesD, &metrics, &work, &nitrun, &nstep)) return NULL; 
#else 
  if (!PyArg_ParseTuple(args, "OOOOii", &zones , &zonesD, &metrics, &work, &nitrun, &nstep)) return NULL; 
#endif
