...
c     $Author: IvanMary $
c***********************************************************************
      subroutine corr_flusenseur_init_select(ndom, ithread, idir, iflow,
...
C Var loc
     ...
     &        +      param_int(ITYPZONE)
       ...
       IF  (option.eq.220) THEN
         ...
         call corr_flusenseur_init_lamin_o3_3dfull(ndom,
     &                 ithread, idir,
     &                 param_int, param_real,
     &                 ind_loop,
     &                 rop, drodm , wig,
     ...
     &                 ti, tj, tk, vol, xmut)
       ...
       ELSEIF (option.eq.221) THEN
         ...
         call corr_flusenseur_init_lamin_o3_3dhomo(ndom,
     &                 ithread, idir,
     &                 param_int, param_real,
     &                 ind_loop,
     &                 rop, drodm , wig,
     ...
     &                 ti, tj, tk, vol, xmut)
       ...
       ELSEIF (option.eq.222) THEN
         ...
         call corr_flusenseur_init_lamin_o3_3dcart(ndom,
     &                 ithread, idir,
     &                 param_int, param_real,
     &                 ind_loop,
     &                 rop, drodm , wig,
     ...
     &                 ti, tj, tk, vol, xmut)
       ...
       ELSEIF (option.eq.223) THEN
         ...
         call corr_flusenseur_init_lamin_o3_2d(ndom,
     &                 ithread, idir,
     &                 param_int, param_real,
     &                 ind_loop,
     &                 rop, drodm , wig,
     ...
     &                 ti, tj, tk, vol, xmut)
       ...
       ELSEIF (option.eq.230) THEN
         ...
         call corr_flusenseur_init_SA_o3_3dfull(ndom,
     &                 ithread, idir,
     &                 param_int, param_real,
     &                 ind_loop,
     &                 rop, drodm , wig,
     ...
     &                 ti, tj, tk, vol, xmut)
       ...
       ELSEIF (option.eq.231) THEN
         ...
         call corr_flusenseur_init_SA_o3_3dhomo(ndom,
     &                 ithread, idir,
     &                 param_int, param_real,
     &                 ind_loop,
     &                 rop, drodm , wig,
     ...
     &                 ti, tj, tk, vol, xmut)
       ...
       ELSEIF (option.eq.232) THEN
         ...
         call corr_flusenseur_init_SA_o3_3dcart(ndom,
     &                 ithread, idir,
     &                 param_int, param_real,
     &                 ind_loop,
     &                 rop, drodm , wig,
     ...
     &                 ti, tj, tk, vol, xmut)
       ...
       ELSEIF (option.eq.233) THEN
         ...
         call corr_flusenseur_init_SA_o3_2d(ndom,
     &                 ithread, idir,
     &                 param_int, param_real,
     &                 ind_loop,
     &                 rop, drodm , wig,
     ...
     &                 ti, tj, tk, vol, xmut)
       ...
       ELSEIF (option.eq.210) THEN
         ...
         call corr_flusenseur_init_euler_o3_3dfull(ndom,
     &                 ithread, idir,
     &                 param_int, param_real,
     &                 ind_loop,
     &                 rop, drodm , wig,
     ...
     &                 ti, tj, tk, vol, xmut)
       ...
       ELSEIF (option.eq.211) THEN
         ...
         call corr_flusenseur_init_euler_o3_3dhomo(ndom,
     &                 ithread, idir,
     &                 param_int, param_real,
     &                 ind_loop,
     &                 rop, drodm , wig,
     ...
     &                 ti, tj, tk, vol, xmut)
       ...
       ELSEIF (option.eq.212) THEN
         ...
         call corr_flusenseur_init_euler_o3_3dcart(ndom,
     &                 ithread, idir,
     &                 param_int, param_real,
     &                 ind_loop,
     &                 rop, drodm , wig,
     ...
     &                 ti, tj, tk, vol, xmut)
       ...
       ELSEIF (option.eq.213) THEN
         ...
         call corr_flusenseur_init_euler_o3_2d(ndom,
     &                 ithread, idir,
     &                 param_int, param_real,
     &                 ind_loop,
     &                 rop, drodm , wig,
     ...
     &                 ti, tj, tk, vol, xmut)
       ...
       ELSEIF (option.eq.1220) THEN
         ...
         call corr_flusenseur_init_ale_lamin_o3_3dfull(ndom,
     &                 ithread, idir,
     &                 param_int, param_real,
     &                 ind_loop,
     &                 rop, drodm , wig,
     ...
     &                 ti, tj, tk, vol, xmut)
       ...
       ELSEIF (option.eq.1221) THEN
         ...
         call corr_flusenseur_init_ale_lamin_o3_3dhomo(ndom,
     &                 ithread, idir,
     &                 param_int, param_real,
     &                 ind_loop,
     &                 rop, drodm , wig,
     ...
     &                 ti, tj, tk, vol, xmut)
       ...
       ELSEIF (option.eq.1222) THEN
         ...
         call corr_flusenseur_init_ale_lamin_o3_3dcart(ndom,
     &                 ithread, idir,
     &                 param_int, param_real,
     &                 ind_loop,
     &                 rop, drodm , wig,
     ...
     &                 ti, tj, tk, vol, xmut)
       ...
       ELSEIF (option.eq.1223) THEN
         ...
         call corr_flusenseur_init_ale_lamin_o3_2d(ndom,
     &                 ithread, idir,
     &                 param_int, param_real,
     &                 ind_loop,
     &                 rop, drodm , wig,
     ...
     &                 ti, tj, tk, vol, xmut)
       ...
       ELSEIF (option.eq.1230) THEN
         ...
         call corr_flusenseur_init_ale_SA_o3_3dfull(ndom,
     &                 ithread, idir,
     &                 param_int, param_real,
     &                 ind_loop,
     &                 rop, drodm , wig,
     ...
     &                 ti, tj, tk, vol, xmut)
       ...
       ELSEIF (option.eq.1231) THEN
         ...
         call corr_flusenseur_init_ale_SA_o3_3dhomo(ndom,
     &                 ithread, idir,
     &                 param_int, param_real,
     &                 ind_loop,
     &                 rop, drodm , wig,
     ...
     &                 ti, tj, tk, vol, xmut)
       ...
       ELSEIF (option.eq.1232) THEN
         ...
         call corr_flusenseur_init_ale_SA_o3_3dcart(ndom,
     &                 ithread, idir,
     &                 param_int, param_real,
     &                 ind_loop,
     &                 rop, drodm , wig,
     ...
     &                 ti, tj, tk, vol, xmut)
       ...
       ELSEIF (option.eq.1233) THEN
         ...
         call corr_flusenseur_init_ale_SA_o3_2d(ndom,
     &                 ithread, idir,
     &                 param_int, param_real,
     &                 ind_loop,
     &                 rop, drodm , wig,
     ...
     &                 ti, tj, tk, vol, xmut)
       ...
       ELSEIF (option.eq.1210) THEN
         ...
         call corr_flusenseur_init_ale_euler_o3_3dfull(ndom,
     &                 ithread, idir,
     &                 param_int, param_real,
     &                 ind_loop,
     &                 rop, drodm , wig,
     ...
     &                 ti, tj, tk, vol, xmut)
       ...
       ELSEIF (option.eq.1211) THEN
         ...
         call corr_flusenseur_init_ale_euler_o3_3dhomo(ndom,
     &                 ithread, idir,
     &                 param_int, param_real,
     &                 ind_loop,
     &                 rop, drodm , wig,
     ...
     &                 ti, tj, tk, vol, xmut)
       ...
       ELSEIF (option.eq.1212) THEN
         ...
         call corr_flusenseur_init_ale_euler_o3_3dcart(ndom,
     &                 ithread, idir,
     &                 param_int, param_real,
     &                 ind_loop,
     &                 rop, drodm , wig,
     ...
     &                 ti, tj, tk, vol, xmut)
       ...
       ELSEIF (option.eq.1213) THEN
         ...
         call corr_flusenseur_init_ale_euler_o3_2d(ndom,
     &                 ithread, idir,
     &                 param_int, param_real,
     &                 ind_loop,
     &                 rop, drodm , wig,
