...
C Var loc
     ...
     &        +      param_int(ITYPZONE)
       ...
       IF  (option.eq.220) THEN
         ...
         call corr_flusenseur_init_lamin_o3_3dfull(ndom, ithread, idir,
     &                 param_int, param_real,
     &                 ind_loop,
     &                 rop, drodm , wig,
     &                 venti, ventj, ventk,
     &                 ti, tj, tk, vol)
       ...
       ELSEIF (option.eq.221) THEN
         ...
         call corr_flusenseur_init_lamin_o3_3dhomo(ndom, ithread, idir,
     &                 param_int, param_real,
     &                 ind_loop,
     &                 rop, drodm , wig,
     &                 venti, ventj, ventk,
     &                 ti, tj, tk, vol)
       ...
       ELSEIF (option.eq.222) THEN
         ...
         call corr_flusenseur_init_lamin_o3_3dcart(ndom, ithread, idir,
     &                 param_int, param_real,
     &                 ind_loop,
     &                 rop, drodm , wig,
     &                 venti, ventj, ventk,
     &                 ti, tj, tk, vol)
       ...
       ELSEIF (option.eq.223) THEN
         ...
         call corr_flusenseur_init_lamin_o3_2d(ndom, ithread, idir,
     &                 param_int, param_real,
     &                 ind_loop,
     &                 rop, drodm , wig,
     &                 venti, ventj, ventk,
     &                 ti, tj, tk, vol)
       ...
       ELSEIF (option.eq.210) THEN
         ...
         call corr_flusenseur_init_euler_o3_3dfull(ndom, ithread, idir,
     &                 param_int, param_real,
     &                 ind_loop,
     &                 rop, drodm , wig,
     &                 venti, ventj, ventk,
     &                 ti, tj, tk, vol)
       ...
       ELSEIF (option.eq.211) THEN
         ...
         call corr_flusenseur_init_euler_o3_3dhomo(ndom, ithread, idir,
     &                 param_int, param_real,
     &                 ind_loop,
     &                 rop, drodm , wig,
     &                 venti, ventj, ventk,
     &                 ti, tj, tk, vol)
       ...
       ELSEIF (option.eq.212) THEN
         ...
         call corr_flusenseur_init_euler_o3_3dcart(ndom, ithread, idir,
     &                 param_int, param_real,
     &                 ind_loop,
     &                 rop, drodm , wig,
     &                 venti, ventj, ventk,
     &                 ti, tj, tk, vol)
       ...
       ELSEIF (option.eq.213) THEN
         ...
         call corr_flusenseur_init_euler_o3_2d(ndom, ithread, idir,
     &                 param_int, param_real,
     &                 ind_loop,
     &                 rop, drodm , wig,
     &                 venti, ventj, ventk,
