...
c     $Author: IvanMary $
c***********************************************************************
      subroutine flusenseur_init_select(ndom, nitcfg, ithread, nptpsi,
...
C Var loc
     ...
     &        +      param_int(ITYPZONE)
       ...
       IF  (option.eq.220) THEN
           ...
           call flusenseur_init_lamin_o3_3dfull(ndom, ithread,
     &                 param_int, param_real,
     &                 ind_dm, ind_loop, ijkv_thread, ijkv_sdm,
     &                 synchro_send_sock, synchro_send_th,
     &                 synchro_receive_sock, synchro_receive_th,
     ...
     &                 ti, tj, tk, vol, xmut)
       ...
       ELSEIF (option.eq.221) THEN
           ...
           call flusenseur_init_lamin_o3_3dhomo(ndom, ithread,
     &                 param_int, param_real,
     &                 ind_dm, ind_loop, ijkv_thread, ijkv_sdm,
     &                 synchro_send_sock, synchro_send_th,
     &                 synchro_receive_sock, synchro_receive_th,
     ...
     &                 ti, tj, tk, vol, xmut)
       ...
       ELSEIF (option.eq.222) THEN
           ...
           call flusenseur_init_lamin_o3_3dcart(ndom, ithread,
     &                 param_int, param_real,
     &                 ind_dm, ind_loop, ijkv_thread, ijkv_sdm,
     &                 synchro_send_sock, synchro_send_th,
     &                 synchro_receive_sock, synchro_receive_th,
     ...
     &                 ti, tj, tk, vol, xmut)
       ...
       ELSEIF (option.eq.223) THEN
           ...
           call flusenseur_init_lamin_o3_2d(ndom, ithread,
     &                 param_int, param_real,
     &                 ind_dm, ind_loop, ijkv_thread, ijkv_sdm,
     &                 synchro_send_sock, synchro_send_th,
     &                 synchro_receive_sock, synchro_receive_th,
     ...
     &                 ti, tj, tk, vol, xmut)
       ...
       ELSEIF (option.eq.230) THEN
           ...
           call flusenseur_init_SA_o3_3dfull(ndom, ithread,
     &                 param_int, param_real,
     &                 ind_dm, ind_loop, ijkv_thread, ijkv_sdm,
     &                 synchro_send_sock, synchro_send_th,
     &                 synchro_receive_sock, synchro_receive_th,
     ...
     &                 ti, tj, tk, vol, xmut)
       ...
       ELSEIF (option.eq.231) THEN
           ...
           call flusenseur_init_SA_o3_3dhomo(ndom, ithread,
     &                 param_int, param_real,
     &                 ind_dm, ind_loop, ijkv_thread, ijkv_sdm,
     &                 synchro_send_sock, synchro_send_th,
     &                 synchro_receive_sock, synchro_receive_th,
     ...
     &                 ti, tj, tk, vol, xmut)
       ...
       ELSEIF (option.eq.232) THEN
           ...
           call flusenseur_init_SA_o3_3dcart(ndom, ithread,
     &                 param_int, param_real,
     &                 ind_dm, ind_loop, ijkv_thread, ijkv_sdm,
     &                 synchro_send_sock, synchro_send_th,
     &                 synchro_receive_sock, synchro_receive_th,
     ...
     &                 ti, tj, tk, vol, xmut)
       ...
       ELSEIF (option.eq.233) THEN
           ...
           call flusenseur_init_SA_o3_2d(ndom, ithread,
     &                 param_int, param_real,
     &                 ind_dm, ind_loop, ijkv_thread, ijkv_sdm,
     &                 synchro_send_sock, synchro_send_th,
     &                 synchro_receive_sock, synchro_receive_th,
     ...
     &                 ti, tj, tk, vol, xmut)
       ...
       ELSEIF (option.eq.210) THEN
           ...
           call flusenseur_init_euler_o3_3dfull(ndom, ithread,
     &                 param_int, param_real,
     &                 ind_dm, ind_loop, ijkv_thread, ijkv_sdm,
     &                 synchro_send_sock, synchro_send_th,
     &                 synchro_receive_sock, synchro_receive_th,
     ...
     &                 ti, tj, tk, vol, xmut)
       ...
       ELSEIF (option.eq.211) THEN
           ...
           call flusenseur_init_euler_o3_3dhomo(ndom, ithread,
     &                 param_int, param_real,
     &                 ind_dm, ind_loop, ijkv_thread, ijkv_sdm,
     &                 synchro_send_sock, synchro_send_th,
     &                 synchro_receive_sock, synchro_receive_th,
     ...
     &                 ti, tj, tk, vol, xmut)
       ...
       ELSEIF (option.eq.212) THEN
           ...
           call flusenseur_init_euler_o3_3dcart(ndom, ithread,
     &                 param_int, param_real,
     &                 ind_dm, ind_loop, ijkv_thread, ijkv_sdm,
     &                 synchro_send_sock, synchro_send_th,
     &                 synchro_receive_sock, synchro_receive_th,
     ...
     &                 ti, tj, tk, vol, xmut)
       ...
       ELSEIF (option.eq.213) THEN
           ...
           call flusenseur_init_euler_o3_2d(ndom, ithread,
     &                 param_int, param_real,
     &                 ind_dm, ind_loop, ijkv_thread, ijkv_sdm,
     &                 synchro_send_sock, synchro_send_th,
     &                 synchro_receive_sock, synchro_receive_th,
     ...
     &                 ti, tj, tk, vol, xmut)
       ...
       ELSEIF (option.eq.1220) THEN
           ...
           call flusenseur_init_ale_lamin_o3_3dfull(ndom, ithread,
     &                 param_int, param_real,
     &                 ind_dm, ind_loop, ijkv_thread, ijkv_sdm,
     &                 synchro_send_sock, synchro_send_th,
     &                 synchro_receive_sock, synchro_receive_th,
     ...
     &                 ti, tj, tk, vol, xmut)
       ...
       ELSEIF (option.eq.1221) THEN
           ...
           call flusenseur_init_ale_lamin_o3_3dhomo(ndom, ithread,
     &                 param_int, param_real,
     &                 ind_dm, ind_loop, ijkv_thread, ijkv_sdm,
     &                 synchro_send_sock, synchro_send_th,
     &                 synchro_receive_sock, synchro_receive_th,
     ...
     &                 ti, tj, tk, vol, xmut)
       ...
       ELSEIF (option.eq.1222) THEN
           ...
           call flusenseur_init_ale_lamin_o3_3dcart(ndom, ithread,
     &                 param_int, param_real,
     &                 ind_dm, ind_loop, ijkv_thread, ijkv_sdm,
     &                 synchro_send_sock, synchro_send_th,
     &                 synchro_receive_sock, synchro_receive_th,
     ...
     &                 ti, tj, tk, vol, xmut)
       ...
       ELSEIF (option.eq.1223) THEN
           ...
           call flusenseur_init_ale_lamin_o3_2d(ndom, ithread,
     &                 param_int, param_real,
     &                 ind_dm, ind_loop, ijkv_thread, ijkv_sdm,
     &                 synchro_send_sock, synchro_send_th,
     &                 synchro_receive_sock, synchro_receive_th,
     ...
     &                 ti, tj, tk, vol, xmut)
       ...
       ELSEIF (option.eq.1230) THEN
           ...
           call flusenseur_init_ale_SA_o3_3dfull(ndom, ithread,
     &                 param_int, param_real,
     &                 ind_dm, ind_loop, ijkv_thread, ijkv_sdm,
     &                 synchro_send_sock, synchro_send_th,
     &                 synchro_receive_sock, synchro_receive_th,
     ...
     &                 ti, tj, tk, vol, xmut)
       ...
       ELSEIF (option.eq.1231) THEN
           ...
           call flusenseur_init_ale_SA_o3_3dhomo(ndom, ithread,
     &                 param_int, param_real,
     &                 ind_dm, ind_loop, ijkv_thread, ijkv_sdm,
     &                 synchro_send_sock, synchro_send_th,
     &                 synchro_receive_sock, synchro_receive_th,
     ...
     &                 ti, tj, tk, vol, xmut)
       ...
       ELSEIF (option.eq.1232) THEN
           ...
           call flusenseur_init_ale_SA_o3_3dcart(ndom, ithread,
     &                 param_int, param_real,
     &                 ind_dm, ind_loop, ijkv_thread, ijkv_sdm,
     &                 synchro_send_sock, synchro_send_th,
     &                 synchro_receive_sock, synchro_receive_th,
     ...
     &                 ti, tj, tk, vol, xmut)
       ...
       ELSEIF (option.eq.1233) THEN
           ...
           call flusenseur_init_ale_SA_o3_2d(ndom, ithread,
     &                 param_int, param_real,
     &                 ind_dm, ind_loop, ijkv_thread, ijkv_sdm,
     &                 synchro_send_sock, synchro_send_th,
     &                 synchro_receive_sock, synchro_receive_th,
     ...
     &                 ti, tj, tk, vol, xmut)
       ...
       ELSEIF (option.eq.1210) THEN
           ...
           call flusenseur_init_ale_euler_o3_3dfull(ndom, ithread,
     &                 param_int, param_real,
     &                 ind_dm, ind_loop, ijkv_thread, ijkv_sdm,
     &                 synchro_send_sock, synchro_send_th,
     &                 synchro_receive_sock, synchro_receive_th,
     ...
     &                 ti, tj, tk, vol, xmut)
       ...
       ELSEIF (option.eq.1211) THEN
           ...
           call flusenseur_init_ale_euler_o3_3dhomo(ndom, ithread,
     &                 param_int, param_real,
     &                 ind_dm, ind_loop, ijkv_thread, ijkv_sdm,
     &                 synchro_send_sock, synchro_send_th,
     &                 synchro_receive_sock, synchro_receive_th,
     ...
     &                 ti, tj, tk, vol, xmut)
       ...
       ELSEIF (option.eq.1212) THEN
           ...
           call flusenseur_init_ale_euler_o3_3dcart(ndom, ithread,
     &                 param_int, param_real,
     &                 ind_dm, ind_loop, ijkv_thread, ijkv_sdm,
     &                 synchro_send_sock, synchro_send_th,
     &                 synchro_receive_sock, synchro_receive_th,
     ...
     &                 ti, tj, tk, vol, xmut)
       ...
       ELSEIF (option.eq.1213) THEN
           ...
           call flusenseur_init_ale_euler_o3_2d(ndom, ithread,
     &                 param_int, param_real,
     &                 ind_dm, ind_loop, ijkv_thread, ijkv_sdm,
     &                 synchro_send_sock, synchro_send_th,
     &                 synchro_receive_sock, synchro_receive_th,
