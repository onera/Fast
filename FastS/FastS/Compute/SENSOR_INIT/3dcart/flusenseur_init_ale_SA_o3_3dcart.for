...
c     $Author: IvanMary $
c***********************************************************************
      subroutine flusenseur_init_ale_SA_o3_3dcart(ndom, ithread,
...
C Var loc
     ...
     & tky,tkz,tkx1,tky1,tkz1,xmutvol,cvisq,rgp,son,c,
...
#include "FastS/Compute/loopI_ale_begin.for"                  
            l0= l  - inck                   
#include    "FastS/Compute/SENSOR_INIT/3dcart/fluFaceEuler_ale_o3_3dcart_k.for"  
#include    "FastS/Compute/SENSOR_INIT/3dcart/fluFaceSA_ale_o3_3dcart_k.for"   
...
#include  "FastS/Compute/loopI_ale_begin.for"
            l0= l  - incj 
#include    "FastS/Compute/SENSOR_INIT/3dcart/fluFaceEuler_ale_o3_3dcart_j.for"
#include    "FastS/Compute/SENSOR_INIT/3dcart/fluFaceSA_ale_o3_3dcart_j.for"
...
#include "FastS/Compute/loopI_ale_begin.for"
            l0= l  - inci
#include    "FastS/Compute/SENSOR_INIT/3dcart/fluFaceEuler_ale_o3_3dcart_i.for"
#include    "FastS/Compute/SENSOR_INIT/3dcart/fluFaceSA_ale_o3_3dcart_i.for"
