...
c     $Author: IvanMary $
c***********************************************************************
      subroutine invlu_ale_l(ndom, param_int, param_real,
     &                   ind_loop,
...
c Var loc
     ...
     & ls,l1s,incis,incjs,incks,lij,ltij,lvij
