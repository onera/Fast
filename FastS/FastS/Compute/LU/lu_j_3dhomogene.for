...
c      b1         = b11*drodm(l1,1)+b12*drodm(l1,2)+b13*drodm(l1,3)
c      drodm(l,1) = drodm(l,1)+b1*xal 
c
c      b1         = b21*drodm(l1,1)+b22*drodm(l1,2)+b23*drodm(l1,3)
c     1            +b24*drodm(l1,4)+b25*drodm(l1,5)
c      drodm(l,2) = drodm(l,2)+b1*xal 
c
c      b1         = b31*drodm(l1,1)+b32*drodm(l1,2)+b33*drodm(l1,3)
c     1            +b34*drodm(l1,4)+b35*drodm(l1,5)
c      drodm(l,3) = drodm(l,3)+b1*xal 
c
c      b1         = b41*drodm(l1,1)+b42*drodm(l1,2)+b43*drodm(l1,3)
c     1            +b44*drodm(l1,4)
c      drodm(l,4) = drodm(l,4)+b1*xal 
c
c      b1         = b51*drodm(l1,1)+b52*drodm(l1,2)+b53*drodm(l1,3)
c     1            +b54*drodm(l1,4)+b55*drodm(l1,5)
c      drodm(l,5) = drodm(l,5)+b1*xal
