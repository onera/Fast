...
c     $Author: IvanMary $
c***********************************************************************
      subroutine tstb3_impli(ndom, first_it, param_int, param_real,
     &                       ind_loop,
...
#include "FastS/formule_param.h"
      ...
      xid=1.                                    !routine valable en dtloc seulement
...
!!coe(2-4) impli pas utiliser dans la suite du cache blocking
!!
