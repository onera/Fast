...
c     $Author: IvanMary $
c***********************************************************************
      subroutine eff_flushyper_select(ndom, ithread,
...
C Var loc
     ...
     &        +      param_int(ITYPZONE)
       ...
       IF  (option.eq.220) THEN
           ...
           call eff_flushyper_lamin_o3_3dfull(ndom, ithread, 
     &                 param_int, param_real,param_int_eff,
     &                 ind_loop, effort, pos,
     &                 rop, flu , wig,
     &                 x, y, z,
     ...
     &                 ti, tj, tk, vol, xmut)
       ...
       ELSEIF (option.eq.221) THEN
           ...
           call eff_flushyper_lamin_o3_3dhomo(ndom, ithread, 
     &                 param_int, param_real,param_int_eff,
     &                 ind_loop, effort, pos,
     &                 rop, flu , wig,
     &                 x, y, z,
     ...
     &                 ti, tj, tk, vol, xmut)
       ...
       ELSEIF (option.eq.222) THEN
           ...
           call eff_flushyper_lamin_o3_3dcart(ndom, ithread, 
     &                 param_int, param_real,param_int_eff,
     &                 ind_loop, effort, pos,
     &                 rop, flu , wig,
     &                 x, y, z,
     ...
     &                 ti, tj, tk, vol, xmut)
       ...
       ELSEIF (option.eq.223) THEN
           ...
           call eff_flushyper_lamin_o3_2d(ndom, ithread, 
     &                 param_int, param_real,param_int_eff,
     &                 ind_loop, effort, pos,
     &                 rop, flu , wig,
     &                 x, y, z,
     ...
     &                 ti, tj, tk, vol, xmut)
       ...
       ELSEIF (option.eq.210) THEN
           ...
           call eff_flushyper_euler_o3_3dfull(ndom, ithread, 
     &                 param_int, param_real,param_int_eff,
     &                 ind_loop, effort, pos,
     &                 rop, flu , wig,
     &                 x, y, z,
     ...
     &                 ti, tj, tk, vol, xmut)
       ...
       ELSEIF (option.eq.211) THEN
           ...
           call eff_flushyper_euler_o3_3dhomo(ndom, ithread, 
     &                 param_int, param_real,param_int_eff,
     &                 ind_loop, effort, pos,
     &                 rop, flu , wig,
     &                 x, y, z,
     ...
     &                 ti, tj, tk, vol, xmut)
       ...
       ELSEIF (option.eq.212) THEN
           ...
           call eff_flushyper_euler_o3_3dcart(ndom, ithread, 
     &                 param_int, param_real,param_int_eff,
     &                 ind_loop, effort, pos,
     &                 rop, flu , wig,
     &                 x, y, z,
     ...
     &                 ti, tj, tk, vol, xmut)
       ...
       ELSEIF (option.eq.213) THEN
           ...
           call eff_flushyper_euler_o3_2d(ndom, ithread, 
     &                 param_int, param_real,param_int_eff,
     &                 ind_loop, effort, pos,
     &                 rop, flu , wig,
     &                 x, y, z,
