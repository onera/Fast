...
a1 = G.cart((0,0,0), (0.5,0.5,0.25), (105,100,9))
a1 = C.addBC2Zone(a1, 'perio_kmin', 'BCautoperiod', 'kmin')
a1 = C.addBC2Zone(a1, 'perio_kmax', 'BCautoperiod', 'kmax')
a1 = C.addBC2Zone(a1, 'extrap', 'BCExtrapolate', 'jmin')
a1 = C.addBC2Zone(a1, 'extrap', 'BCExtrapolate', 'jmax')
a1 = C.addBC2Zone(a1, 'ov', 'BCOverlap', 'imax')
a2 = G.cart((50,0,0), (0.5,0.5,0.25), (100,100,9))
a2 = C.addBC2Zone(a2, 'perio_kmin', 'BCautoperiod', 'kmin')
a2 = C.addBC2Zone(a2, 'perio_kmax', 'BCautoperiod', 'kmax')
a2 = C.addBC2Zone(a2, 'extrap', 'BCExtrapolate', 'jmin')
a2 = C.addBC2Zone(a2, 'extrap', 'BCExtrapolate', 'jmax')
...
numz = {'time_step':0.01, 'scheme':'senseur', 'slope':'o3sc', 'extract_res':0}
